...
# shellcheck disable=SC2154
 ...
 #
 # Copyright (c) 2018-2023 Panchajanya1999 <rsk52959@gmail.com>
 #
...
ClangMoreStrings="AR=llvm-ar NM=llvm-nm AS=llvm-as STRIP=llvm-strip OBJCOPY=llvm-objcopy OBJDUMP=llvm-objdump READELF=llvm-readelf HOSTAR=llvm-ar HOSTAS=llvm-as LD_LIBRARY_PATH=$clangDir/lib LLVM=1 LLVM_IAS=1 LD=ld.lld HOSTLD=ld.lld"	elif [ $COMPILER = "gcc" ]
	then
